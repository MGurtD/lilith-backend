...
{
    public partial class Refactor_PricesToTwoDecimalPlaces : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("DROP VIEW public.\"vw_consolidatedExpenses\";");

            migrationBuilder.Sql("UPDATE public.\"BudgetDetails\" SET \"UnitPrice\" = ROUND(\"UnitPrice\", 2);");
            migrationBuilder.Sql("UPDATE public.\"BudgetDetails\" SET \"Amount\" = \"Quantity\" * \"UnitPrice\";");

            migrationBuilder.Sql("UPDATE public.\"SalesOrderDetail\" SET \"UnitPrice\" = ROUND(\"UnitPrice\", 2);");
            migrationBuilder.Sql("UPDATE public.\"SalesOrderDetail\" SET \"Amount\" = \"Quantity\" * \"UnitPrice\";");

            migrationBuilder.Sql("UPDATE public.\"DeliveryNoteDetails\" SET \"UnitPrice\" = ROUND(\"UnitPrice\", 2);");
            migrationBuilder.Sql("UPDATE public.\"DeliveryNoteDetails\" SET \"Amount\" = \"Quantity\" * \"UnitPrice\";");
