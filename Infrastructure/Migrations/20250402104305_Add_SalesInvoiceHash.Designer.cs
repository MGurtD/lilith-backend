...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Audit.HttpTransactionLog", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK_LogHttpTransactions");
            ...
            modelBuilder.Entity("Domain.Entities.Sales.SalesInvoiceHash", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("FechaExpedicionFactura")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("varchar");
                    ...
                    b.Property<string>("IDEmisorFactura")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("varchar");

                    b.Property<string>("IDEmisorFacturaAnulada")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("varchar");
                    ...
                    b.Property<string>("NumSerieFactura")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("varchar");

                    b.Property<string>("NumSerieFacturaAnulada")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("varchar");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_SalesInvoiceHash");

                    b.HasIndex("SalesInvoiceID")
                        .IsUnique();

                    b.ToTable("SalesInvoiceHash");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Sales.SalesInvoiceHash", b =>
                {
                    b.HasOne("Domain.Entities.Sales.SalesInvoice", "SalesInvoice")
                        .WithOne("SalesInvoiceHash")
                        .HasForeignKey("Domain.Entities.Sales.SalesInvoiceHash", "SalesInvoiceID")
